...
public class CloudSimRR {
	...
	public static void main(String[] args) {
		Log.printLine("Starting CloudSimExampleRR...");
		...
		try {
			...
			DatacenterBrokerRR broker = createBroker();
	...
	private static DatacenterBrokerRR createBroker(){

		DatacenterBrokerRR broker = null;
		try {
			broker = new DatacenterBrokerRR("Broker");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
